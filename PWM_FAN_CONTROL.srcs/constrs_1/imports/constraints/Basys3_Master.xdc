...
set_property PACKAGE_PIN A14 [get_ports {lcd_0}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {lcd_0}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {lcd_1}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {lcd_1}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {lcd_2}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {lcd_2}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {lcd_3}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {lcd_3}]
##Sch name = JB7
